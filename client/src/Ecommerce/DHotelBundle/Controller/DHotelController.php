...
use Ecommerce\DHotelBundle\Entity\Hotel;

//ajouter le formulaire de type form HotelType 

use Ecommerce\DHotelBundle\Form\HotelType;

class DHotelController extends Controller
{  
 ...
 /* ajout d'un Hotel*/ 
    ...
    //on crée un objet Hotel
    	...
    	if($this->get('request')->getMethod() == "POST"){
         ...
         if($form->isValid()){
                    ...
                    return $this->redirect($this->generateUrl('voirhotel', array('id' => $Hotel->getId())));
                }else{
                    $this->render("DHotelBundle:DHotel:ajoutHotel.html.twig", array('form' => $form->createView(), ));
                }

        }else{

    	   return $this->render("DHotelBundle:DHotel:ajoutHotel.html.twig", array('form' => $form->createView(), ));
        }
    }
    ...
    public function voirHotelAction($id){
        ...
        if($id >= 0){
            ...
            if($Hotel === null){
                return $this->render("DHotelBundle:DHotel:errorHotelInexistant.html.twig");
            }else{

                //on affiche
                return $this->render("DHotelBundle:DHotel:voirHotel.html.twig", array('Hotel' => $Hotel->getContenu()));
            }
        }
        else{
            return $this->render("DHotelBundle:DHotel:listeHotel.html.twig");
        }
    } 
    ...
    public function listeRestaurantAction(){
            ...
            if($Hotel=== null){
                ...
                return $this->render("DHotelBundle:DHotel:listeHotel.html.twig", array('Hotels' => $res ));
            }
    } 
     ...
     public function modifieHotelAction($id){
        ...
        if($this->get('request')->getMethod() == "POST"){
           ...
           return $this->render("DHotelBundle:DHotel:modifieHotel.html.twig", array('form' => $form->createView(), 'id' => $id ));
...
private function reqSelectHotel($id_Hotel){
        ...
        $Hotel = $em->getRepository('DHotelBundle:Hotel')->find($id_Hotel);
...
private function reqSelectAllHotel(){
        ...
        $Hotels = $em->getRepository('DHotelBundle:Hotel')->findAll();
