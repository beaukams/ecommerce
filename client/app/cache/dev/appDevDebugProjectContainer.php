...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'EcomProduitBundle', '/home/abdoulaye/workspace/projets/e_commerce/client/app/Resources/EcomProduitBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'EcomProduitBundle', '/home/abdoulaye/workspace/projets/e_commerce/client/src/Ecom/ProduitBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'EcomProduitBundle' => 'Ecom\\ProduitBundle\\EcomProduitBundle',
