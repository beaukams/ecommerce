...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Ecommerce/BoutiqueBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Ecommerce/UserBundle/Entity'), 2 => ($this->targetDirs[3].'/src/Ecommerce/RestaurantBundle/Entity'), 3 => ($this->targetDirs[3].'/src/Ecommerce/DHotelBundle/Entity')));
        ...
        $d->addDriver($b, 'Ecommerce\\DHotelBundle\\Entity');
        $d->addDriver($c, 'FOS\\UserBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('EcommerceBoutiqueBundle' => 'Ecommerce\\BoutiqueBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'EcommerceUserBundle' => 'Ecommerce\\UserBundle\\Entity', 'EcommerceRestaurantBundle' => 'Ecommerce\\RestaurantBundle\\Entity', 'DHotelBundle' => 'Ecommerce\\DHotelBundle\\Entity'));
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $b), 'main', $c, $d), 2 => $j, 3 => $m, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $i, $g, $c, $d, true, $h), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '57bf90c3173e66.59494009', $c, $g), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, '/login', false), NULL, NULL, $c, false));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Ecommerce/DHotelBundle/Resources/views'), 'DHotel');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'DHotelBundle' => 'Ecommerce\\DHotelBundle\\DHotelBundle',
