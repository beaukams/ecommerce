...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'siteecommerce', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Ecommerce/BoutiqueBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Ecommerce/UserBundle/Entity'), 2 => ($this->targetDirs[3].'/src/Ecommerce/HotelBundle/Entity'), 3 => ($this->targetDirs[3].'/src/Ecommerce/RestaurantBundle/Entity')));
        ...
        $d->addDriver($b, 'Ecommerce\\BoutiqueBundle\\Entity');
        $d->addDriver($b, 'Ecommerce\\UserBundle\\Entity');
        $d->addDriver($b, 'Ecommerce\\HotelBundle\\Entity');
        $d->addDriver($b, 'Ecommerce\\RestaurantBundle\\Entity');
        $d->addDriver($c, 'FOS\\UserBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('EcommerceBoutiqueBundle' => 'Ecommerce\\BoutiqueBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'EcommerceUserBundle' => 'Ecommerce\\UserBundle\\Entity', 'HotelBundle' => 'Ecommerce\\HotelBundle\\Entity', 'EcommerceRestaurantBundle' => 'Ecommerce\\RestaurantBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c3fb384d330e0981451aa17a2d5e3e4f4419085122aed10d0a9f46732d63324f');
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Ecommerce\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Ecommerce\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Ecommerce\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Ecommerce\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $b), 'main', $c, $d), 2 => $j, 3 => $m, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $i, $g, $c, $d, true, $h), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '57be488290e966.17525172', $c, $g), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, '/login', false), NULL, NULL, $c, false));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Ecommerce/BoutiqueBundle/Resources/views'), 'EcommerceBoutique');
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'/src/Ecommerce/UserBundle/Resources/views'), 'EcommerceUser');
        $instance->addPath(($this->targetDirs[3].'/src/Ecommerce/HotelBundle/Resources/views'), 'Hotel');
        $instance->addPath(($this->targetDirs[3].'/src/Ecommerce/CultureBundle/Resources/views'), 'EcommerceCulture');
        $instance->addPath(($this->targetDirs[3].'/src/Ecommerce/RestaurantBundle/Resources/views'), 'EcommerceRestaurant');
        $instance->addPath(($this->targetDirs[3].'/src/Ecommerce/GHotelBundle/Resources/views'), 'GHotel');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'EcommerceBoutiqueBundle' => 'Ecommerce\\BoutiqueBundle\\EcommerceBoutiqueBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'EcommerceUserBundle' => 'Ecommerce\\UserBundle\\EcommerceUserBundle',
                'HotelBundle' => 'Ecommerce\\HotelBundle\\HotelBundle',
                'EcommerceCultureBundle' => 'Ecommerce\\CultureBundle\\EcommerceCultureBundle',
                'EcommerceRestaurantBundle' => 'Ecommerce\\RestaurantBundle\\EcommerceRestaurantBundle',
                'GHotelBundle' => 'Ecommerce\\GHotelBundle\\GHotelBundle',
            ...
            'fos_user.model.user.class' => 'Ecommerce\\UserBundle\\Entity\\User',
