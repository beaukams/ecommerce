...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // ecommerce_ghotel_default_index
        if (rtrim($pathinfo, '/') === '/fou') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'ecommerce_ghotel_default_index');
            }

            return array (  '_controller' => 'Ecommerce\\GHotelBundle\\Controller\\DefaultController::indexAction',  '_route' => 'ecommerce_ghotel_default_index',);
        }
