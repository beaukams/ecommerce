...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/boutique')) {
            ...
            if (0 === strpos($pathinfo, '/boutique/produit')) {
                ...
                if ($pathinfo === '/boutique/produit/liste') {
                    return array (  '_controller' => 'Ecommerce\\BoutiqueBundle\\Controller\\ProduitController::listeProduitAction',  '_route' => 'listeProduit',);
                }
        ...
        if (0 === strpos($pathinfo, '/hotel/hotel') && preg_match('#^/hotel/hotel/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ecommerce_hotel_default_index')), array (  '_controller' => 'Ecommerce\\HotelBundle\\Controller\\DefaultController::indexAction',));
        }
