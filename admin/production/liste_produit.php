          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Gestion de vente de légumes <small>Produits</small></h3>
              </div>
                        ...
                        <tbody>
                          <?php
                                  ...
                                  if(isset($res)){
                                        ...
                                        foreach ($res as $key_t => $value_t) {
                                          echo "<tr>";
                                            foreach ($value_t as $key_p => $prod) {
                                                if($key_p < 4)
                                                  echo "<td>" . $value_t[$key_p] . "</td>";

                                            }
                                              echo "<td><input type='radio' onchange='give_value(this)' name='coches[]' value=" . $value_t[0] . "></td>";
                        ...
                        <div class='form-group' style='height:30px;'>
                          <div style='display:inline-block; height:30px;'>
                              <form action='modif_produit.php' method='post'>
                                  <input type='text' id='id_produit_1' name='id_produit' hidden/>
                          ...
                          <div style='display:inline-block;height:30px;'>
                            <form action='del_produit.php' method='post'>
                                <input type='text' id='id_produit_2' name='id_produit' hidden/>
    ...
    <script>
      ...
      function give_value(obj){
          if(obj.checked){
              ...
              document.getElementById("id_produit_1").value = obj.value;
              document.getElementById("id_produit_2").value = obj.value;
          }
      }
    </script>
    <!-- /Datatables -->
